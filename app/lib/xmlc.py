    ...
    with tempfile.NamedTemporaryFile("wb") as f_X2:
        ...
        *_, C_tst_pred, tst_embeddings = matcher.predict(
            argparse.NameSpace(**{
                ...
                'trn_label_path': './data/intermediary-data/xbert_outputs/proc_data/C.trn.text-emb-s0.npz',
                'tst_label_path': './data/intermediary-data/xbert_outputs/proc_data/C.tst.text-emb-s0.npz',
                'output_dir': './data/intermediary-data/xbert_outputs/text-emb-s0/matcher',
                'config_name': '',
                'cache_dir': '',
                'do_train': False,
                'do_eval': True,
