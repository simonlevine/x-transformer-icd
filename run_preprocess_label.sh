...
DATA_DIR=$'/content/auto-icd/data/intermediary-data/xbert_input' 
...
PROC_DATA_DIR=$'/content/auto-icd-transformers/xbert_output/processed_data' #${OUTPUT_DIR}/proc_data
